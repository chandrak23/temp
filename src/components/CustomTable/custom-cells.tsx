...
export const BadgeCell = ({ dataItem, ...props }) => {
...
export const BudgetCell = ({ dataItem, ...props }) => {
...
export const PersonCell = ({ dataItem, ...props }) => {
...
export const CountryCell = ({ dataItem, ...props }) => {
